...
\begin{enumerate}
 \item Aplikaci vytvořte v \glsname{HTML}5, aby byla na současných, obzvláště mobilních, zařízeních multiplatformní. Bude funkční minimálně v nejnovějších verzích \glsname{OS} Android, iOS a Symbian.
