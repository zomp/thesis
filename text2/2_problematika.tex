...
Fakulta informačních technologií Českého vysokého učení technického v Praze, stejně tak, jako většina ostatních obdobných institucí, nabízí studentům nepřeberné množství informací. Nějteré se nacházejí na webové stránce fakulty (\url{http://fit.cvut.cz/}), univerzity (\url{http://www.cvut.cz/}), jiné na serverech edux (\url{https://edux.fit.cvut.cz/}) a komponenta studia (\url{https://kos.cvut.cz/}), další pak pod Správou účelových zařízení (\url{http://agata.suz.cvut.cz/jidelnicky/}) nebo třeba na webu Centra informačních a poradenských služeb ČVUT (\url{http://www.cips.cvut.cz/}).

Zorientovat se ve zdrojích nějakou dobu trvá, v těch nejdůležitějších zpravidla ani 
\todo{Dohromady celá doména -- serverová i mobilní aplikace.}

\section{Popis uživatele a jeho potřeb}
\todo{Stručně, konrétně pak pod kapitolou věnující se analýze. Opět dohromady.}

\section{Vymezení cílů diplomové práce}
\todo{...}

\section{Popis struktury DP ve vztahu k vytyčeným cílům}
\todo{Popis rozdělení na serverovou a mobilní aplikaci}
