...
\todo{Netestoval jsem podle žádné metodiky a testy neměly formální průběh. Mám to ještě nějak metodicky otestovat nebo stačí rozepsat následující body?}
% \subsection{Statické a dynamické testování}
% \subsection{Testování vstupů}
...
\subsection{Testování kompatibility s prohlížeči}
...
\subsection{Srovnání s existujícími řešeními}
